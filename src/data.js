...
export const descriptionHybrid =[{
  description :'Maple Floor Series Hybrid SPC Waterproof Flooring, designed for modern Australian homes, features advanced German-engineered waterproof technology and EIR surfaces for a realistic texture. This series offers rich, nature-inspired colors that create a vibrant and inviting atmosphere in any room. Ideal for living spaces, kitchens, and bedrooms, it combines elegance with practical performance, adding warmth and sophistication to every interior'
}]
