...
import img1 from "../assets/img/heroSlider/3033.png";
import img2 from "../assets/img/heroSlider/HW8022-1.jpg";
import img3 from "../assets/img/heroSlider/HW8101.png";
      ...
      {slides.map((slide,index)=>{
        ...
        <SwiperSlide className="h-full relative flex justify-center items-center" key={index}>
          <div className="z-20 text-white text-center">
            <div className="uppercase font-tertiary tracking-[6px] mb-5 ">Flooring specialists
            in Melbourne</div>
